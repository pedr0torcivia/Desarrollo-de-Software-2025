...
// GET /parciales - Obtener todos los parciales
...
// GET /parciales/filtro?legajo=...&materia=... - Filtro por legajo y materia
router.get("/filtro", async (req, res) => {
  try {
    const { legajo, materia } = req.query;
    const parciales = await parcialesService.getAllByFiltro({ legajo, materia });
    res.json(parciales);
  } catch (error) {
